package com.springbootapp.awsimageupload.service;

import com.springbootapp.awsimageupload.adapter.S3Adapter;
import com.springbootapp.awsimageupload.bucket.BucketName;
import com.springbootapp.awsimageupload.model.UserProfile;
import com.springbootapp.awsimageupload.repository.UserProfileDataAccessRepository;
...
public class UserProfileService {
    ...
    public void uploadUserProfileImage(UUID userProfileId, MultipartFile file) {
        ...
        try {
            s3Adapter.save(path, filename, Optional.of(metadata), file.getInputStream());
    ...
    public byte[] downloadUserProfileImage(UUID userProfileId) {
        ...
        return user.getUserProfileImageLink()
                .map(key -> s3Adapter.download(path, key))
                .orElse(new byte[0]);
